...
export class CourseListComponent implements OnInit {
  ...
  constructor(private courseService: LessonService, private router:Router, private toastrService: ToastrService) { }
  ...
  goToCourseDetail(course:Lesson){
    this.router.navigate(['/course-details', course.guid])
  }
